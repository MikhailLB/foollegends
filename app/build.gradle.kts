...
val grayBundleId    = grayProp("gray.bundleId", "com.example.grayshell")
...
// ─── Emit BuildConfig fields ────────────────────────────────────────────────
// Every downstream Kotlin file reads its per-project values from BuildConfig.
// Nothing is hand-written any more, and grepping the source for "259200",
// "app_push_channel", "fl_state" and their siblings returns nothing.

// ─── Signing (kept from the previous file) ─────────────────────────────────
